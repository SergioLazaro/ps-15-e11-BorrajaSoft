...
public class DataExtraction {
   ...
   public Customer getCustomerInfo(int idUser) throws SQLException{
	   ResultSet result = mda.getQuery("SELECT * FROM Customers WHERE customerID = " + idUser);
	   ...
	   if (customer==null) throw new SQLException();
       return customer;
   }
