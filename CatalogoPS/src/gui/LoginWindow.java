	...
	public int login() {
		...
		try {
			...
			UIManager.put("OptionPane.background", new ColorUIResource(
					Colors.background2));
			UIManager.put("Panel.background", new ColorUIResource(
					Colors.background2));
			...
			// Align rows
			layout.putConstraint(SpringLayout.WEST, usr, 5, SpringLayout.EAST,
					label2);
			layout.putConstraint(SpringLayout.WEST, pass, 5, SpringLayout.EAST,
					label2);
