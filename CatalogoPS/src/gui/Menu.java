...
public class Menu{
	...
	public Menu(JLayeredPane panel){
		...
		try {
			selectionTree.setModel(new DefaultTreeModel(
				new DefaultMutableTreeNode("Clothes") {
	...
	/**
	 * Get the JTree associated with the menu.
	 * This method is intended to be used for defining actionListeners
	 * @return
	 */
