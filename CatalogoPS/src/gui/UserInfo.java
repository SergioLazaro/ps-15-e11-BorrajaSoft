...
/**
 * Class that manages the User Info Panel
 * @author Hijus
 *
 */
...
//		this.setLayout(BorderLayout.);
		...
		String[] labelsArray = {"First Name", "Last Name", "Mail Address", 
				"Delivering Address", "Phone Number", "Password", "Confirm Password"};
...
//				System.out.println("pass = [" + new String(password.getPassword()) + "] cpass = [" + new String(cPassword.getPassword()) + "]");
